...
public class DynamicDataSourceAnnotationInterceptor implements MethodInterceptor {
    ...
    private String determineDatasource(MethodInvocation invocation) {
        ...
        if (METHOD_CACHE.containsKey(method)) {
            ...
            DataSourceTarget ds = method.isAnnotationPresent(DataSourceTarget.class) ? method.getAnnotation(DataSourceTarget.class)
                    : AnnotationUtils.findAnnotation(method.getDeclaringClass(), DataSourceTarget.class);
